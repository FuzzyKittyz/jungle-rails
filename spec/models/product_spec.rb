...
RSpec.describe Product, type: :model do
  describe "Validations" do
    it "validates if a product is valid" do
      ...
      @product = Product.new(name: "Plant1", price: 400, quantity: 30, category: @category)
    ...
    it "throws an error when quantity is blank" do
      @category = Category.new(name: "Home")
      @product = Product.new(name: "Plant1", price: 400, quantity: nil, category: @category)
      expect(@product).to be_invalid
    ...
    it "throws an error when category is blank" do
      @category = Category.new(name: "Home")
      @product = Product.new(name: "Plant1", price: 400, quantity: 30, category: nil)
      expect(@product).to be_invalid
